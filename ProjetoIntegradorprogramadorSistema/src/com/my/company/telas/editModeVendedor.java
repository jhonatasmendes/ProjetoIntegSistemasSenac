 ...
 */
public class editModeVendedor extends javax.swing.JFrame {

    /**
     * Creates new form editModeConteudo
     */
    public editModeVendedor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Essa tabela não permite editar ou deletar os vendedores.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editModeVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editModeVendedor().setVisible(true);
            }
        });
    }
