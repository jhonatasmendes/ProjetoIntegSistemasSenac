 ...
 */
public class editModeCliente extends javax.swing.JFrame {

    /**
     * Creates new form editModeConteudo
     */
    public editModeCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Essa tabela não permite editar ou deletar os clientes.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editModeCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editModeCliente().setVisible(true);
            }
        });
    }
